...
from semiparametrictransfer.policies.gcbc_policy import GCBCPolicyImagesDagger
...
policy = {
    ...
    'default_policy_type': GCBCPolicyImagesDagger, 
    'policy_T': 50,
    ...
    'model_override_params': {
        ...
        'test_time_task_id': [52]  #put broccoli in pot or pan": 53, put sushi on plate": 49, put green squash into pot or pan": 52,
